...
package com.liferay.task.management.service.persistence;
...
/**
 * The persistence utility for the task service. This utility wraps <code>com.liferay.task.management.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	...
	public static Task findByUuid_First(
		...
		throws com.liferay.task.management.exception.NoSuchTaskException {
	 ...
	 * @return the ordered range of matching tasks
	 */
	public static List<Task> findByStatus(
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByStatus_First(
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByStatus_First(
		int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByStatus_Last(
			int status, OrderByComparator<Task> orderByComparator)
		throws com.liferay.task.management.exception.NoSuchTaskException {
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByStatus_Last(
		int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a task with the primary key could not be found
	 */
	public static Task[] findByStatus_PrevAndNext(
