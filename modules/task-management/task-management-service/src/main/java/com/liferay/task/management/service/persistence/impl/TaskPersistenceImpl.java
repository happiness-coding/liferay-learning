...
package com.liferay.task.management.service.persistence.impl;
...
import com.liferay.task.management.model.TaskTable;
import com.liferay.task.management.model.impl.TaskImpl;
import com.liferay.task.management.model.impl.TaskModelImpl;
import com.liferay.task.management.service.persistence.TaskPersistence;
import com.liferay.task.management.service.persistence.TaskUtil;
import com.liferay.task.management.service.persistence.impl.constants.TaskManagementPersistenceConstants;
...
public class TaskPersistenceImpl
	 ...
	 */
	@Override
	public Task findByStatus_First(
	 ...
	 */
	@Override
	public Task fetchByStatus_First(
		int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 */
	@Override
	public Task fetchByStatus_Last(
		int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 */
	@Override
	public Task[] findByStatus_PrevAndNext(
			long taskId, int status, OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {
		...
		try {
			...
			array[0] = getByStatus_PrevAndNext(
				session, task, status, orderByComparator, true);

			array[1] = task;

			array[2] = getByStatus_PrevAndNext(
				session, task, status, orderByComparator, false);
	...
	protected Task getByStatus_PrevAndNext(
		Session session, Task task, int status,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	@Override
	@Reference(
		target = TaskManagementPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TaskManagementPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
